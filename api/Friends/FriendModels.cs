...
public record FriendRequestDto(Guid UserId, string Username, string DisplayName, DateTime SentAt);
...
public static class FriendMappings
{
    public static FriendRequestDto ToRequestDto(this Friendship f, ApplicationUser requester) =>
        new(requester.Id, requester.UserName!, requester.DisplayName, f.CreatedAt);
